...
namespace Image2PDF.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Cerca una stringa localizzata simile a Image files|*.jpg; *.gif; *.png; *.tiff; *.bmp; *.svg; *.wmf|File JPEG|*.jpg|File GIF|*.gif|File PNG|*.png|File SVG|*.svg|File BMP|*.bmp|File WMF|*.wmf|File TIFF|*.tiff.
        /// </summary>
